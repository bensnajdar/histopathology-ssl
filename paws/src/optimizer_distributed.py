...
import math
from apex.optimizers import FusedSGD, FusedLAMB
...
def init_opt(encoder, iterations_per_epoch, start_lr, ref_lr, ref_mom, nesterov, warmup, batches, weight_decay=1e-6, final_lr=0.0):
    ...
    optimizer = FusedSGD(params=param_groups, lr=ref_lr, momentum=ref_mom, weight_decay=weight_decay, nesterov=nesterov)
    #optimizer = FusedLAMB(params=param_groups, lr=ref_lr, weight_decay=weight_decay)
